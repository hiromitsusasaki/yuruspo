class Activity < ApplicationRecord
  ...
  def self.where_query(search_query)
    ...
    return Activity.joins(place_content: :place).select("activities.id, activities.circle_id, activities.place_content_id, activities.date, place_contents.*, places.city_id").where(where_arr)
  end
