class Activity < ApplicationRecord
  ...
  def self.where_query(search_query)
    ...
    p activity = Activity.joins(place_contents: :places).select("activities.id, activities.circle_id, activities.place_content_id, activities.date, place_contents.*, places.city_id").where(where_arr)
    return activity
  end
