...
このREADMEの内容は**まだまだ検討中の段階**です。皆さんの忌憚のないご意見をお待ちしています。<br />
...
ControllerはLineサーバからのリクエストを受け付けることのみ(Webhook)を行います。<br />
ModelはDBとのやり取り及びそのModel固有の処理を担当するようにします。実際の処理（ビジネスロジック）は下記のクラス図のような設計を考えています。**が、この設計で本当に良いのかちょっと悩んでます。ご意見頂きたいです。**<br />

![画像](https://dl.dropboxusercontent.com/s/9t7r6xvf2cs0wk4/line_bot_module_class_diagram.png)
